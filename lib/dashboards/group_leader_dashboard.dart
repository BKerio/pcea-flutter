...
class GroupLeaderDashboard extends StatefulWidget {
  const GroupLeaderDashboard({Key? key}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              'Group Leader ${_currentUser?.name ?? 'Leader'}',
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildDashboardCard(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Member engagement tools coming soon!')),
                      );
                    },
                  ),
                  _buildDashboardCard(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Activity coordination coming soon!')),
                      );
                    },
                  ),
                  _buildDashboardCard(
                  ...
                  _buildDashboardCard(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Group reports coming soon!')),
                      );
                    },
                  ),
                ],
